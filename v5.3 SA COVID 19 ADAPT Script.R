# PROJECT:  South Africa CoVID 19 ADAPT Data Validation
# AUTHOR:   D.Collison | USAID
# PURPOSE:  ADAPT Data Quality Check 
# REF ID:   c80ff8c2 
# LICENSE:  MIT
# DATE:     2023-05-18
# UPDATED: 
...
##Read in ADAPT datasets using google drive (EVERY TIME STEP)
...
##Create data frames for each Level 2 Check
...
##SCLEAN PERIOD ONLY: Automatically append POSTCLEAN results to master  DQRT google spreadsheet; ONLY RUN THIS AFTER PARTNER DATA HAS BEEN REVIEWED AND UPDATES HAVE BEEN MADE TO TOOLS BY PARTNERS.Note that if you rerun it mutliple tabs, it will update in the DQRT spreadsheets multiple times.
