...
#NOTE THAT THE FOLLOWING UPDATES WILL BE MADE TO THIS SCRIPT BY 8.26: CODE TO AUTOMATICALLY APPEND TO EXISTING DQRT SPREADSHEETS
...
# NOTE that if checks are blank, you can exclude them from bind, as character types may cause issues (i.e. July 2022 only had a flag in check 6, so below I only included that in the bind)
...
##TO AUTOMATICALLY APPEND TO EXISITNG DQRT TRACKERS:
     #COMING SOON!
```
