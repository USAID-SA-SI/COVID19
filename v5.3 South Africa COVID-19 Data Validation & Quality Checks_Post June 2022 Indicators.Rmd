...
#This section pulls from the live google sheets that partners update
   ...
   ADAPT_HST <-read_sheet(as_sheets_id('1k2yDUZk49SRjTq3ceeXzogUw1TnMszjdXGtYJFwW060'), sheet="HST_v3", guess_max = 10000)
   ADAPT_THINK <-read_sheet(as_sheets_id('1k2yDUZk49SRjTq3ceeXzogUw1TnMszjdXGtYJFwW060'), sheet="THINK_v3", guess_max = 10000)
