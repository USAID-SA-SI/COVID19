...
date: "last updated 1/31/2023 w/ new age/sex & modality checks and updated sheet ids for ADAPT tool"
...
#This section pulls from the live google sheets that partners update
     ...
     ADAPT_RTC <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet = "RTC_v3", guess_max = 10000)
     ADAPT_ANOVA <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet = "ANOVA_v3", guess_max = 10000)
     ADAPT_PulseHealth <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet = "PulseHealth_v3", guess_max = 10000)
     ADAPT_Khethimpilo <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet = "Khethimpilo_v3", guess_max = 10000)
     ADAPT_WDED <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet = "WDED_v3", guess_max = 10000)
    ADAPT_Aurum <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet = "Aurum_v3", guess_max = 10000)
    ADAPT_ReAction <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet="ReAction!_v3", guess_max = 10000) 
   ADAPT_HST <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet="HST_v3", guess_max = 10000)
   ADAPT_THINK <-read_sheet(as_sheets_id('1v-5xHU9aK59miudKSyY8WLQRZgpaCEZMk-42GXnGWJQ'), sheet="THINK_v3", guess_max = 10000)
ADAPT <-bind_rows(ADAPT_RTC,ADAPT_ANOVA, ADAPT_PulseHealth, ADAPT_Khethimpilo, ADAPT_WDED, ADAPT_Aurum, ADAPT_ReAction, ADAPT_HST, ADAPT_THINK)
...
```{r}
  ...
  Level1_ADAPT<-Level1 %>% 
    dplyr::filter(`Partner`== "Right to Care" |`Partner`== "WDED"|`Partner`== "Pulse Health"|`Partner`== "ANOVA"|`Partner`== "Kheth’impilo"|`Partner`== "THE AURUM INSTITUTE"|`Partner`== "Re-Action!" |`Partner`== "HST" |`Partner`== "THINK")
  Level2_ADAPT<-Level2 %>% 
    dplyr::filter(`Partner`== "Right to Care" |`Partner`== "WDED"|`Partner`== "Pulse Health"|`Partner`== "ANOVA"|`Partner`== "Kheth’impilo"|`Partner`== "THE AURUM INSTITUTE"|`Partner`== "Re-Action!"|`Partner`== "HST" |`Partner`== "THINK")
```
