...
ADAPT <-bind_rows(ADAPT_RTC,ADAPT_ANOVA, ADAPT_PulseHealth, ADAPT_Khethimpilo, ADAPT_WDED, ADAPT_Aurum, ADAPT_ReAction)
...
```{r}
  ...
  Level1_ADAPT<-Level1 %>% 
    dplyr::filter(`Partner`== "Right to Care" |`Partner`== "WDED"|`Partner`== "Pulse Health"|`Partner`== "ANOVA"|`Partner`== "Kheth’impilo"|`Partner`== "THE AURUM INSTITUTE"|`Partner`== "Re-Action!")
