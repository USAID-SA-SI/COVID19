...
date: "last updated 6/10/2022 NOTE THAT THIS IS STILL IN PROGRESS"
...
##Step 9a: Save results to existing Google Worksheet Workbook in google drive

```{r} 
#https://tcbanalytics.com/2017/01/01/update-google-sheets-via-r-automatically/

  #ANOVA
gs_ANOVA<-gs_key('1r1Fq1ZZyrsIbktsSlKJkqw08qRlQPOwTlZlobgbRr6U')
  gs_edit_cells(gs_ANOVA, ws='Level1', input=colnames(Level1_ANOVA), byrow=TRUE, anchor="A1")
  gs_edit_cells(gs_ANOVA, ws='Level1', input = Level1_ANOVA, anchor="A2", col_names=FALSE, trim=TRUE)
  gs_edit_cells(gs_ANOVA, ws='Level2', input=colnames(Level2_ANOVA), byrow=TRUE, anchor="A1")
  gs_edit_cells(gs_ANOVA, ws='Level2', input = Level2_ANOVA, anchor="A2", col_names=FALSE, trim=TRUE)
...
##Step 9b: Save results in existing Excel Workbook on desktop (Optional)
